...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet"
        href="<c:url value="/resources/bower_components/morris.js/morris.css" /> ">
  <!-- jvectormap -->
  <link rel="stylesheet"
        href="<c:url value="/resources/bower_components/jvectormap/jquery-jvectormap.css"/>">
  <!-- Date Picker -->
  <link rel="stylesheet"
        href="<c:url value="/resources/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css"/>">
  <!-- Daterange picker -->
  <link rel="stylesheet"
        href="<c:url value="/resources/bower_components/bootstrap-daterangepicker/daterangepicker.css"/>">
...
<header class="main-header">
  ...
  <a href="index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
    <span class="logo-mini"><b>E</b>PIC</span> <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>Agent</b>Banking</span>
  </a>
