...
<!-- jQuery UI 1.11.4 -->
<script
		src="<c:url value="/resources/bower_components/jquery-ui/jquery-ui.min.js"/>"></script>
...
<script
		src="<c:url value="/resources/bower_components/morris.js/morris.min.js"/>"></script>
<!-- Sparkline -->
<script
		src="<c:url value="/resources/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"/>"></script>
<!-- jvectormap -->
<script
...
<!-- jQuery Knob Chart -->
<script
		src="<c:url value="/resources/bower_components/jquery-knob/dist/jquery.knob.min.js"/>"></script>
<!-- daterangepicker -->
<script
...
<!-- FastClick -->
<script
		src="<c:url value="/resources/bower_components/fastclick/lib/fastclick.js"/>"></script>
<!-- AdminLTE App -->
